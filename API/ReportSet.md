...
The ReportSet class is the definition of Izenda reports themselves. It contains the properties and metadata of the report and provides methods for interacting with it. It is provided at runtime as a parameter by various AdHocConfig methods, and can also be serialized from XML.

##Property List

These properties define the report's construction, design, identity, and used by the driver to construct teh reporting query, and by the viewer to style and draw the results.

* [[ReportName|http://wiki.izenda.us/API/ReportSet/ReportName]] - The name the report was saved with

##Method List

These methods provide mechanisms for interacting with a report object. 


* [[ReadXML|http://wiki.izenda.us/API/ReportSet/ReadXML]] - Takes XML as a parameter and generates a reportset object based on its contents.
